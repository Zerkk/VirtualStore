...
<div class="row">
	...
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<div class="form-group">
			...
			<select for="tipo_documento" name="tipo_documento" id="inTipoComprobante" class="form-control" >
	...
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		...
		<input class="form-control" required value="{{old('num_comprobante')}}" type="text" id="inNumComprobante" name="NumComprobante" placeholder="Codigo">
	</div>
</div>
<div class="row">
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<label for="codigo"> Fecha</label>
		<input class="form-control" required value="{{old('fecha')}}" type="date" id="infecha" name="fecha" placeholder="Fecha">
	</div>
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
...
<div class="row">
	...
	<div class="form-group">
		<label>Proveedores</label>
				<select id="ProveedoresSelect" name="t_provedores_idt_provedores" class="form-control" >
